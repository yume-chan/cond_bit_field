...
mod exp_golomb {
    ...
    const _IMPL_NUM_FromPrimitive_FOR_UnsignedExpGolombCode: () =
        {
            ...
            impl _num_traits::FromPrimitive for UnsignedExpGolombCode {
                ...
                fn from_i64(n: i64) -> Option<Self> {
                    <u64 as
                        _num_traits::FromPrimitive>::from_i64(n).map(UnsignedExpGolombCode)
                }
                #[inline]
                fn from_u64(n: u64) -> Option<Self> {
                    <u64 as
                        _num_traits::FromPrimitive>::from_u64(n).map(UnsignedExpGolombCode)
                }
                #[inline]
                fn from_isize(n: isize) -> Option<Self> {
                    <u64 as
                        _num_traits::FromPrimitive>::from_isize(n).map(UnsignedExpGolombCode)
                }
                #[inline]
                fn from_i8(n: i8) -> Option<Self> {
                    <u64 as
                        _num_traits::FromPrimitive>::from_i8(n).map(UnsignedExpGolombCode)
                }
                #[inline]
                fn from_i16(n: i16) -> Option<Self> {
                    <u64 as
                        _num_traits::FromPrimitive>::from_i16(n).map(UnsignedExpGolombCode)
                }
                #[inline]
                fn from_i32(n: i32) -> Option<Self> {
                    <u64 as
                        _num_traits::FromPrimitive>::from_i32(n).map(UnsignedExpGolombCode)
                }
                #[inline]
                fn from_i128(n: i128) -> Option<Self> {
                    <u64 as
                        _num_traits::FromPrimitive>::from_i128(n).map(UnsignedExpGolombCode)
                }
                #[inline]
                fn from_usize(n: usize) -> Option<Self> {
                    <u64 as
                        _num_traits::FromPrimitive>::from_usize(n).map(UnsignedExpGolombCode)
                }
                #[inline]
                fn from_u8(n: u8) -> Option<Self> {
                    <u64 as
                        _num_traits::FromPrimitive>::from_u8(n).map(UnsignedExpGolombCode)
                }
                #[inline]
                fn from_u16(n: u16) -> Option<Self> {
                    <u64 as
                        _num_traits::FromPrimitive>::from_u16(n).map(UnsignedExpGolombCode)
                }
                #[inline]
                fn from_u32(n: u32) -> Option<Self> {
                    <u64 as
                        _num_traits::FromPrimitive>::from_u32(n).map(UnsignedExpGolombCode)
                }
                #[inline]
                fn from_u128(n: u128) -> Option<Self> {
                    <u64 as
                        _num_traits::FromPrimitive>::from_u128(n).map(UnsignedExpGolombCode)
                }
                #[inline]
                fn from_f32(n: f32) -> Option<Self> {
                    <u64 as
                        _num_traits::FromPrimitive>::from_f32(n).map(UnsignedExpGolombCode)
                }
                #[inline]
                fn from_f64(n: f64) -> Option<Self> {
                    <u64 as
                        _num_traits::FromPrimitive>::from_f64(n).map(UnsignedExpGolombCode)
                }
            }
        };
    impl ::core::ops::Add for UnsignedExpGolombCode {
        ...
        fn add(self, other: Self) -> Self {
            UnsignedExpGolombCode(<u64 as
                                      ::core::ops::Add>::add(self.0, other.0))
        }
    }
    impl ::core::ops::Sub for UnsignedExpGolombCode {
        ...
        fn sub(self, other: Self) -> Self {
            UnsignedExpGolombCode(<u64 as
                                      ::core::ops::Sub>::sub(self.0, other.0))
        }
    }
    impl ::core::ops::Mul for UnsignedExpGolombCode {
        ...
        fn mul(self, other: Self) -> Self {
            UnsignedExpGolombCode(<u64 as
                                      ::core::ops::Mul>::mul(self.0, other.0))
        }
    }
    impl ::core::ops::Div for UnsignedExpGolombCode {
        ...
        fn div(self, other: Self) -> Self {
            UnsignedExpGolombCode(<u64 as
                                      ::core::ops::Div>::div(self.0, other.0))
        }
    }
    impl ::core::ops::Rem for UnsignedExpGolombCode {
        ...
        fn rem(self, other: Self) -> Self {
            UnsignedExpGolombCode(<u64 as
                                      ::core::ops::Rem>::rem(self.0, other.0))
        }
    }
    #[allow(non_upper_case_globals, unused_qualifications)]
    ...
    impl BitField for UnsignedExpGolombCode {
        fn read(reader: &mut impl BitRead) -> Result<Self> {
            let mut length = 0;
            while !reader.read_bit()? { length += 1; }
            if length == 0 { return Ok(UnsignedExpGolombCode(0)); }
            Ok(UnsignedExpGolombCode(1 << length |
                                         reader.read_sized::<u64, u8>(length)?
                                             - 1))
        }
    }
    ...
    const _IMPL_NUM_FromPrimitive_FOR_SignedExpGolombCode: () =
        {
            ...
            impl _num_traits::FromPrimitive for SignedExpGolombCode {
                ...
                fn from_i64(n: i64) -> Option<Self> {
                    <i64 as
                        _num_traits::FromPrimitive>::from_i64(n).map(SignedExpGolombCode)
                }
                #[inline]
                fn from_u64(n: u64) -> Option<Self> {
                    <i64 as
                        _num_traits::FromPrimitive>::from_u64(n).map(SignedExpGolombCode)
                }
                #[inline]
                fn from_isize(n: isize) -> Option<Self> {
                    <i64 as
                        _num_traits::FromPrimitive>::from_isize(n).map(SignedExpGolombCode)
                }
                #[inline]
                fn from_i8(n: i8) -> Option<Self> {
                    <i64 as
                        _num_traits::FromPrimitive>::from_i8(n).map(SignedExpGolombCode)
                }
                #[inline]
                fn from_i16(n: i16) -> Option<Self> {
                    <i64 as
                        _num_traits::FromPrimitive>::from_i16(n).map(SignedExpGolombCode)
                }
                #[inline]
                fn from_i32(n: i32) -> Option<Self> {
                    <i64 as
                        _num_traits::FromPrimitive>::from_i32(n).map(SignedExpGolombCode)
                }
                #[inline]
                fn from_i128(n: i128) -> Option<Self> {
                    <i64 as
                        _num_traits::FromPrimitive>::from_i128(n).map(SignedExpGolombCode)
                }
                #[inline]
                fn from_usize(n: usize) -> Option<Self> {
                    <i64 as
                        _num_traits::FromPrimitive>::from_usize(n).map(SignedExpGolombCode)
                }
                #[inline]
                fn from_u8(n: u8) -> Option<Self> {
                    <i64 as
                        _num_traits::FromPrimitive>::from_u8(n).map(SignedExpGolombCode)
                }
                #[inline]
                fn from_u16(n: u16) -> Option<Self> {
                    <i64 as
                        _num_traits::FromPrimitive>::from_u16(n).map(SignedExpGolombCode)
                }
                #[inline]
                fn from_u32(n: u32) -> Option<Self> {
                    <i64 as
                        _num_traits::FromPrimitive>::from_u32(n).map(SignedExpGolombCode)
                }
                #[inline]
                fn from_u128(n: u128) -> Option<Self> {
                    <i64 as
                        _num_traits::FromPrimitive>::from_u128(n).map(SignedExpGolombCode)
                }
                #[inline]
                fn from_f32(n: f32) -> Option<Self> {
                    <i64 as
                        _num_traits::FromPrimitive>::from_f32(n).map(SignedExpGolombCode)
                }
                #[inline]
                fn from_f64(n: f64) -> Option<Self> {
                    <i64 as
                        _num_traits::FromPrimitive>::from_f64(n).map(SignedExpGolombCode)
                }
            }
        };
...
impl SizedBitField for ScalingList {
    fn read_sized(reader: &mut impl BitRead, size: u8) -> Result<Self> {
        ...
        if last_scale == 0 {
            for _ in 0..size { list.push(8); }
            return Ok(Self{list, use_default_scaling_matrix_flag: true,});
        }
        let mut j = 1u8;
        loop  {
            let delta_scale: SignedExpGolombCode = reader.read()?;
            let next_scale: u8 =
                ((last_scale as i64 + delta_scale.0 + 256) % 256) as u8;
            j += 1;
            if next_scale != 0 {
                last_scale = next_scale;
                list.push(last_scale);
            } else { list.push(last_scale); break ; }
            if j == size {
                return Ok(Self{list,
                               use_default_scaling_matrix_flag: false,});
            }
        }
        while j < size { list.push(last_scale); }
        Ok(Self{list, use_default_scaling_matrix_flag: false,})
    }
}
...
impl ::cond_bit_stream::BitField for SequenceParameterSet {
    fn read(reader: &mut impl ::cond_bit_stream::BitRead)
     -> ::cond_bit_stream::Result<Self> {
        ...
        let mut qpprime_y_zero_transform_bypass_flag_8N9l:
                std::option::Option<bool> = None;
        #[allow(non_snake_case)]
        let mut bit_depth_luma_minus8_UPBn:
                std::option::Option<UnsignedExpGolombCode> = None;
        #[allow(non_snake_case)]
        let mut scaling_list_4x4_JkKV:
                std::option::Option<std::vec::Vec<ScalingList>> = None;
        #[allow(non_snake_case)]
        let mut seq_scaling_matrix_present_flag_2HKl:
                std::option::Option<bool> = None;
        #[allow(non_snake_case)]
        let mut separate_colour_plane_flag_6rHL: std::option::Option<bool> =
            None;
        #[allow(non_snake_case)]
        let mut scaling_list_8x8_oGAa:
                std::option::Option<std::vec::Vec<ScalingList>> = None;
        #[allow(non_snake_case)]
        let mut chroma_format_idc_GvTB:
                std::option::Option<UnsignedExpGolombCode> = None;
        #[allow(non_snake_case)]
        let mut bit_depth_chroma_minus8_1p7t:
                std::option::Option<UnsignedExpGolombCode> = None;
        if profile_idc == 100 || profile_idc == 110 || profile_idc == 122 ||
               profile_idc == 244 || profile_idc == 44 || profile_idc == 83 ||
               profile_idc == 86 || profile_idc == 118 || profile_idc == 128
               || profile_idc == 138 || profile_idc == 139 ||
               profile_idc == 134 || profile_idc == 135 {
            let chroma_format_idc: UnsignedExpGolombCode = reader.read()?;
            #[allow(non_snake_case)]
            let mut separate_colour_plane_flag_nd8R:
                    std::option::Option<bool> = None;
            if chroma_format_idc.0 == 3 {
                let separate_colour_plane_flag: bool = reader.read_bit()?;
                separate_colour_plane_flag_nd8R =
                    Some(separate_colour_plane_flag);
            }
            ...
            let bit_depth_chroma_minus8: UnsignedExpGolombCode =
                reader.read()?;
            let qpprime_y_zero_transform_bypass_flag: bool =
                reader.read_bit()?;
            let seq_scaling_matrix_present_flag: bool = reader.read_bit()?;
            #[allow(non_snake_case)]
            let mut scaling_list_4x4_vqwJ:
                    std::option::Option<std::vec::Vec<ScalingList>> = None;
            #[allow(non_snake_case)]
            let mut scaling_list_8x8_0KCJ:
                    std::option::Option<std::vec::Vec<ScalingList>> = None;
            if seq_scaling_matrix_present_flag {
                #[allow(non_snake_case)]
                let mut scaling_list_4x4_Vc7k: std::vec::Vec<ScalingList> =
                    std::vec::Vec::new();
                for _ in 0..6 {
                    let scaling_list_4x4: ScalingList =
                        reader.read_sized(16)?;
                    scaling_list_4x4_Vc7k.push(scaling_list_4x4);
                }
                let scaling_list_4x4 = scaling_list_4x4_Vc7k;
                #[allow(non_snake_case)]
                let mut scaling_list_8x8_jnNh: std::vec::Vec<ScalingList> =
                    std::vec::Vec::new();
                for _ in 0..(if chroma_format_idc.0 != 3 { 2 } else { 6 }) {
                    let scaling_list_8x8: ScalingList =
                        reader.read_sized(64)?;
            ...
            qpprime_y_zero_transform_bypass_flag_8N9l =
                Some(qpprime_y_zero_transform_bypass_flag);
            seq_scaling_matrix_present_flag_2HKl =
                Some(seq_scaling_matrix_present_flag);
        ...
        #[allow(non_snake_case)]
        let mut delta_pic_order_always_zero_flag_DHIq:
                std::option::Option<bool> = None;
        #[allow(non_snake_case)]
        let mut num_ref_frames_in_pic_order_cnt_cycle_4EvH:
                std::option::Option<UnsignedExpGolombCode> = None;
        #[allow(non_snake_case)]
        let mut offset_for_non_ref_pic_9ltp:
                std::option::Option<SignedExpGolombCode> = None;
        #[allow(non_snake_case)]
        let mut log2_max_pic_order_cnt_lsb_minus4_aUuD:
                std::option::Option<UnsignedExpGolombCode> = None;
        #[allow(non_snake_case)]
        let mut offset_for_top_to_bottom_field_hNwq:
                std::option::Option<SignedExpGolombCode> = None;
        #[allow(non_snake_case)]
        let mut offset_for_ref_frame_U4Np:
                std::option::Option<std::vec::Vec<SignedExpGolombCode>> =
            None;
        match pic_order_cnt_type.0 {
            0 => {
                let log2_max_pic_order_cnt_lsb_minus4: UnsignedExpGolombCode =
                    reader.read()?;
                log2_max_pic_order_cnt_lsb_minus4_aUuD =
                    Some(log2_max_pic_order_cnt_lsb_minus4);
            }
            1 => {
                let delta_pic_order_always_zero_flag: bool =
                    reader.read_bit()?;
                let offset_for_non_ref_pic: SignedExpGolombCode =
                    reader.read()?;
                let offset_for_top_to_bottom_field: SignedExpGolombCode =
                    reader.read()?;
                let num_ref_frames_in_pic_order_cnt_cycle:
                        UnsignedExpGolombCode = reader.read()?;
                #[allow(non_snake_case)]
                let mut offset_for_ref_frame_FDqQ:
                        std::vec::Vec<SignedExpGolombCode> =
                    std::vec::Vec::new();
                for _ in 0..num_ref_frames_in_pic_order_cnt_cycle.0 {
                    let offset_for_ref_frame: SignedExpGolombCode =
                        reader.read()?;
                    offset_for_ref_frame_FDqQ.push(offset_for_ref_frame);
                }
                let offset_for_ref_frame = offset_for_ref_frame_FDqQ;
                delta_pic_order_always_zero_flag_DHIq =
                    Some(delta_pic_order_always_zero_flag);
                offset_for_non_ref_pic_9ltp = Some(offset_for_non_ref_pic);
                offset_for_top_to_bottom_field_hNwq =
                    Some(offset_for_top_to_bottom_field);
                num_ref_frames_in_pic_order_cnt_cycle_4EvH =
                    Some(num_ref_frames_in_pic_order_cnt_cycle);
                offset_for_ref_frame_U4Np = Some(offset_for_ref_frame);
            }
            _ => { }
        };
        let delta_pic_order_always_zero_flag =
            delta_pic_order_always_zero_flag_DHIq;
        let num_ref_frames_in_pic_order_cnt_cycle =
            num_ref_frames_in_pic_order_cnt_cycle_4EvH;
        ...
        let pic_height_in_map_units_minus1: UnsignedExpGolombCode =
            reader.read()?;
        let frame_mbs_only_flag: bool = reader.read_bit()?;
        #[allow(non_snake_case)]
        let mut mb_adaptive_frame_field_flag_WyGN: std::option::Option<bool> =
            None;
        if !frame_mbs_only_flag {
            let mb_adaptive_frame_field_flag: bool = reader.read_bit()?;
            mb_adaptive_frame_field_flag_WyGN =
                Some(mb_adaptive_frame_field_flag);
        }
        ...
        #[allow(non_snake_case)]
        let mut frame_crop_bottom_offset_B0O7:
                std::option::Option<UnsignedExpGolombCode> = None;
        #[allow(non_snake_case)]
        let mut frame_crop_left_offset_zfjk:
                std::option::Option<UnsignedExpGolombCode> = None;
        #[allow(non_snake_case)]
        let mut frame_crop_top_offset_lMhf:
                std::option::Option<UnsignedExpGolombCode> = None;
        #[allow(non_snake_case)]
        let mut frame_crop_right_offset_dTaW:
                std::option::Option<UnsignedExpGolombCode> = None;
        if frame_cropping_flag {
            let frame_crop_left_offset: UnsignedExpGolombCode =
                reader.read()?;
            let frame_crop_right_offset: UnsignedExpGolombCode =
                reader.read()?;
            let frame_crop_top_offset: UnsignedExpGolombCode = reader.read()?;
            let frame_crop_bottom_offset: UnsignedExpGolombCode =
                reader.read()?;
        ...
        Ok(SequenceParameterSet{profile_idc,
...
impl ::cond_bit_stream::BitField for PictureParameterSet {
    fn read(reader: &mut impl ::cond_bit_stream::BitRead)
     -> ::cond_bit_stream::Result<Self> {
        let pic_parameter_set_id: UnsignedExpGolombCode = reader.read()?;
        let seq_parameter_set_id: UnsignedExpGolombCode = reader.read()?;
        let entropy_coding_mode_flag: bool = reader.read_bit()?;
        let bottom_field_pic_order_in_frame_present_flag: bool =
            reader.read_bit()?;
        let num_slice_groups_minus1: UnsignedExpGolombCode = reader.read()?;
        #[allow(non_snake_case)]
        let mut top_left_Aznt:
                std::option::Option<std::vec::Vec<UnsignedExpGolombCode>> =
            None;
        #[allow(non_snake_case)]
        let mut slice_group_id_b3cF: std::option::Option<std::vec::Vec<u8>> =
            None;
        #[allow(non_snake_case)]
        let mut pic_size_in_map_units_minus1_I3J4:
                std::option::Option<UnsignedExpGolombCode> = None;
        #[allow(non_snake_case)]
        let mut slice_group_change_rate_minus1_Zz3Q:
                std::option::Option<UnsignedExpGolombCode> = None;
        #[allow(non_snake_case)]
        let mut run_length_minus1_z1W7:
                std::option::Option<std::vec::Vec<UnsignedExpGolombCode>> =
            None;
        #[allow(non_snake_case)]
        let mut slice_group_map_type_5V2s:
                std::option::Option<UnsignedExpGolombCode> = None;
        #[allow(non_snake_case)]
        let mut bottom_right_6T4Y:
                std::option::Option<std::vec::Vec<UnsignedExpGolombCode>> =
            None;
        #[allow(non_snake_case)]
        let mut slice_group_change_direction_flag_jM2p:
                std::option::Option<bool> = None;
        if num_slice_groups_minus1.0 > 0 {
            let slice_group_map_type: UnsignedExpGolombCode = reader.read()?;
            #[allow(non_snake_case)]
            let mut top_left_Ja72:
                    std::option::Option<std::vec::Vec<UnsignedExpGolombCode>> =
                None;
            #[allow(non_snake_case)]
            let mut slice_group_change_rate_minus1_U14G:
                    std::option::Option<UnsignedExpGolombCode> = None;
            #[allow(non_snake_case)]
            let mut slice_group_change_direction_flag_BNm1:
                    std::option::Option<bool> = None;
            #[allow(non_snake_case)]
            let mut run_length_minus1_2bOn:
                    std::option::Option<std::vec::Vec<UnsignedExpGolombCode>> =
                None;
            #[allow(non_snake_case)]
            let mut bottom_right_Trwr:
                    std::option::Option<std::vec::Vec<UnsignedExpGolombCode>> =
                None;
            #[allow(non_snake_case)]
            let mut slice_group_id_UE9l:
                    std::option::Option<std::vec::Vec<u8>> = None;
            #[allow(non_snake_case)]
            let mut pic_size_in_map_units_minus1_Ha3H:
                    std::option::Option<UnsignedExpGolombCode> = None;
            match slice_group_map_type.0 {
                0 => {
                    #[allow(non_snake_case)]
                    let mut run_length_minus1_vPSL:
                            std::vec::Vec<UnsignedExpGolombCode> =
                        std::vec::Vec::new();
                    for _ in 0..=num_slice_groups_minus1.0 {
                        let run_length_minus1: UnsignedExpGolombCode =
                            reader.read()?;
                ...
                2 => {
                    #[allow(non_snake_case)]
                    let mut top_left_6EDj:
                            std::vec::Vec<UnsignedExpGolombCode> =
                        std::vec::Vec::new();
                    #[allow(non_snake_case)]
                    let mut bottom_right_V27H:
                            std::vec::Vec<UnsignedExpGolombCode> =
                        std::vec::Vec::new();
                    for _ in 0..=num_slice_groups_minus1.0 {
                        let top_left: UnsignedExpGolombCode = reader.read()?;
                        let bottom_right: UnsignedExpGolombCode =
                            reader.read()?;
                ...
                3 | 4 | 5 => {
                    ...
                    let slice_group_change_rate_minus1:
                            UnsignedExpGolombCode = reader.read()?;
                    slice_group_change_direction_flag_BNm1 =
                        Some(slice_group_change_direction_flag);
                    slice_group_change_rate_minus1_U14G =
                        Some(slice_group_change_rate_minus1);
                }
                6 => {
                    let pic_size_in_map_units_minus1: UnsignedExpGolombCode =
                        reader.read()?;
                    #[allow(non_snake_case)]
                    let mut slice_group_id_2GFn: std::vec::Vec<u8> =
                        std::vec::Vec::new();
                    for _ in 0..pic_size_in_map_units_minus1.0 {
                        let slice_group_id: u8 =
                            reader.read_sized((num_slice_groups_minus1.0 as
                                                   f32 + 1f32).log2().ceil()
                                                  as u8)?;
                        slice_group_id_2GFn.push(slice_group_id);
                    }
                    let slice_group_id = slice_group_id_2GFn;
                    pic_size_in_map_units_minus1_Ha3H =
                        Some(pic_size_in_map_units_minus1);
            ...
            slice_group_change_direction_flag_jM2p =
                slice_group_change_direction_flag;
            slice_group_change_rate_minus1_Zz3Q =
        ...
        let slice_group_change_direction_flag =
            slice_group_change_direction_flag_jM2p;
        let num_ref_idx_l0_default_active_minus1: UnsignedExpGolombCode =
            reader.read()?;
        let num_ref_idx_l1_default_active_minus1: UnsignedExpGolombCode =
            reader.read()?;
        ...
        Ok(PictureParameterSet{pic_parameter_set_id,
                               seq_parameter_set_id,
...
mod test {
    ...
    #[cfg(test)]
    #[rustc_test_marker]
    pub const parse_pic_param_set: test::TestDescAndFn =
        test::TestDescAndFn{desc:
                                test::TestDesc{name:
                                                   test::StaticTestName("test::parse_pic_param_set"),
                                               ignore: false,
                                               allow_fail: false,
                                               should_panic:
                                                   test::ShouldPanic::No,
                            ...
                            testfn:
                                test::StaticTestFn(||
                                                       test::assert_test_result(parse_pic_param_set())),};
